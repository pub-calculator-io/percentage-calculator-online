...
Version: 1.0.0
Author: Percentage Calculator Online / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Percentage Calculator Online by www.calculator.io";

function display_calcio_ci_percentage_calculator_online(){
    $page = 'index.html';
...
add_shortcode( 'ci_percentage_calculator_online', 'display_calcio_ci_percentage_calculator_online' );